...
IF NOT EXISTS (SELECT 1 FROM dbo.books WHERE id = 3)
    INSERT dbo.books (id, title, authorId, genre, publicationdate, imageurl) 
    VALUES (3, '2001: A Space Odyssey', 3, 'Science fiction', CAST('1926-04-02' AS Date), 'https://upload.wikimedia.org/wikipedia/en/thumb/0/05/Littleprince.JPG/220px-Littleprince.JPG');
